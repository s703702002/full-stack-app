          ...
          {isEditing ? (
            <div className="space-y-3">
              <input
                ...
                className="w-full max-w-sm border-b-2 border-slate-300 px-0 py-1 text-2xl font-bold text-slate-900 focus:outline-none focus:border-primary bg-transparent transition-colors"
                placeholder="請輸入姓名"
              />
              {/* 🚀 新增 Bio 編輯文字框 */}
              <textarea
                ...
                maxLength={160}
                className="w-full max-w-md bg-slate-50 border border-slate-200 rounded-lg p-3 text-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none min-h-[80px]"
              />
